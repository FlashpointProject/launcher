...
export class Initial1593172736527 implements MigrationInterface {
    name = 'Initial1593172736527'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "primaryAliasId" integer, "categoryId" integer, "description" varchar, CONSTRAINT "REL_3c002904ab97fb1b4e61e8493c" UNIQUE ("primaryAliasId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "game" ("id" varchar PRIMARY KEY NOT NULL, "parentGameId" varchar, "title" varchar COLLATE NOCASE NOT NULL, "alternateTitles" varchar COLLATE NOCASE NOT NULL, "series" varchar COLLATE NOCASE NOT NULL, "developer" varchar COLLATE NOCASE NOT NULL, "publisher" varchar COLLATE NOCASE NOT NULL, "dateAdded" datetime NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "platform" varchar COLLATE NOCASE NOT NULL, "broken" boolean NOT NULL, "extreme" boolean NOT NULL, "playMode" varchar COLLATE NOCASE NOT NULL, "status" varchar COLLATE NOCASE NOT NULL, "notes" varchar COLLATE NOCASE NOT NULL, "source" varchar COLLATE NOCASE NOT NULL, "applicationPath" varchar NOT NULL, "launchCommand" varchar NOT NULL, "releaseDate" varchar COLLATE NOCASE NOT NULL, "version" varchar COLLATE NOCASE NOT NULL, "originalDescription" varchar COLLATE NOCASE NOT NULL, "language" varchar COLLATE NOCASE NOT NULL, "library" varchar COLLATE NOCASE NOT NULL, "orderTitle" varchar COLLATE NOCASE NOT NULL)`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_game" ("id" varchar PRIMARY KEY NOT NULL, "parentGameId" varchar, "title" varchar COLLATE NOCASE NOT NULL, "alternateTitles" varchar COLLATE NOCASE NOT NULL, "series" varchar COLLATE NOCASE NOT NULL, "developer" varchar COLLATE NOCASE NOT NULL, "publisher" varchar COLLATE NOCASE NOT NULL, "dateAdded" datetime NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "platform" varchar COLLATE NOCASE NOT NULL, "broken" boolean NOT NULL, "extreme" boolean NOT NULL, "playMode" varchar COLLATE NOCASE NOT NULL, "status" varchar COLLATE NOCASE NOT NULL, "notes" varchar COLLATE NOCASE NOT NULL, "source" varchar COLLATE NOCASE NOT NULL, "applicationPath" varchar NOT NULL, "launchCommand" varchar NOT NULL, "releaseDate" varchar COLLATE NOCASE NOT NULL, "version" varchar COLLATE NOCASE NOT NULL, "originalDescription" varchar COLLATE NOCASE NOT NULL, "language" varchar COLLATE NOCASE NOT NULL, "library" varchar COLLATE NOCASE NOT NULL, "orderTitle" varchar COLLATE NOCASE NOT NULL, CONSTRAINT "FK_45a9180069d42ac8231ff11acd0" FOREIGN KEY ("parentGameId") REFERENCES "game" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "dateModified" datetime NOT NULL DEFAULT (datetime('now')), "primaryAliasId" integer, "categoryId" integer, "description" varchar, CONSTRAINT "REL_3c002904ab97fb1b4e61e8493c" UNIQUE ("primaryAliasId"))`, undefined);
        await queryRunner.query(`INSERT INTO "tag"("id", "dateModified", "primaryAliasId", "categoryId", "description") SELECT "id", "dateModified", "primaryAliasId", "categoryId", "description" FROM "temporary_tag"`, undefined);
