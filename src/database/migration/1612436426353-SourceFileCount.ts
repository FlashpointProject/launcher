...
export class SourceFileCount1612436426353 implements MigrationInterface {
    name = 'SourceFileCount1612436426353'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_source" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "dateAdded" datetime NOT NULL, "lastUpdated" datetime NOT NULL, "sourceFileUrl" varchar NOT NULL, "baseUrl" varchar NOT NULL, "count" integer NOT NULL)`);
        await queryRunner.query(`INSERT INTO "temporary_source"("id", "name", "dateAdded", "lastUpdated") SELECT "id", "name", "dateAdded", "lastUpdated" FROM "source"`);
        await queryRunner.query(`DROP TABLE "source"`);
        await queryRunner.query(`ALTER TABLE "temporary_source" RENAME TO "source"`);
    }
