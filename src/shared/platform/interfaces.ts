...
/**
 * This interface represents a Game as stored in Platform XMLs
 * Comments represent their XML data types and IPureGameInfo counterparts
 * (NOTE: Best not to mess with the casing of the fields)
 */
...
/**
 * This interface represents an Additional Application as stored in Platform XMLs
