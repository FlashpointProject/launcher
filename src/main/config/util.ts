...
export function overwriteConfigData(
  ...
  parser.prop('flashpointPath',      v => source.flashpointPath      = str(v));
  parser.prop('imageFolderPath',     v => source.imageFolderPath     = str(v));
  parser.prop('logoFolderPath',      v => source.logoFolderPath      = str(v));
  parser.prop('playlistFolderPath',  v => source.playlistFolderPath  = str(v));
  parser.prop('jsonFolderPath',      v => source.jsonFolderPath      = str(v));
