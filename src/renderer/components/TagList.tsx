...
export class TagList extends React.Component<TagListProps> {
  ...
  currentTags: TAGS | undefined = undefined;
  ...
  render() {
    ...
    if (tagsChanged) { console.log('tags changed'); console.log(tags); this.currentTags = tags; }
    // Render
    return (
  ...
  rowRenderer = (props: ListRowProps): React.ReactNode => {
    ...
    console.log('Rendering Row ' + props.index);
