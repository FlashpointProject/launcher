import { BackInit, BackInitArgs, BackOut, LanguageChangeData, LanguageListChangeData, PlaylistRemoveData, PlaylistUpdateData, ThemeChangeData, ThemeListChangeData } from '@shared/back/types';
import { GamePlaylist, IBackProcessInfo, IService, RecursivePartial } from '@shared/interfaces';
