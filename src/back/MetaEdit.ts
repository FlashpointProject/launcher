...
import { OpenMessageBoxFunc } from './types';
 ...
 */
export async function importAllMetaEdits(fullMetaEditsFolderPath: string, openDialog: OpenMessageBoxFunc): Promise<ImportMetaEditResult> {
  const errors: Error[] = [];
